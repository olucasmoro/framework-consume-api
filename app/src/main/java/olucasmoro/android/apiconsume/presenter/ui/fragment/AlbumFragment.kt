...
import olucasmoro.android.apiconsume.presenter.ui.adapter.AlbumAdapter
...
class AlbumFragment : Fragment() {
    ...
    private val mAdapter: AlbumAdapter = AlbumAdapter()
    ...
    private fun setupRecycler() {
        listViewModel.albums.value?.let { list ->
    ...
    private fun listsObserver() {
        ...
        listViewModel.albums.observe(viewLifecycleOwner) { listAlbum ->
            mAdapter.updateList(listAlbum)
            binding.recyclerList.adapter = mAdapter
        }
    }
